...
import interfaccia_grafica as ui
...
def PDF_To_MD(filename, parole_proibite):                                #funzione che unisce tutte le funzioni precedenti, chiede input all'utente e fa partire i thread
        ...
        parole=parole_proibite.lower().split(",")
        #print(parole)
